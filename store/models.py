...
class SizeVariation(models.Model):
    ...
    kare = models.CharField(max_length=250, null=True, blank=True)
    ...
    def __str__(self):
        ...
        return f"{self.product.product_name}  - {self.size.name} - {self.price}" 
 

class SitesShowFooter(models.Model):
    name = models.CharField(max_length=255, unique=True)
    link = models.URLField()
    mobile_video_url = models.URLField(blank=True, null=True)
    tablet_video_url = models.URLField(blank=True, null=True)
    desktop_video_url = models.URLField(blank=True, null=True)
