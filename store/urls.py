...
urlpatterns = [
    ...
    path('increment-view-count/<str:product_slug>/', views.increment_view_count, name='increment_view_count'),
    ...
    path('product/<str:product_slug>/like/', views.like_product, name='like_product'),
