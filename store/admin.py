...
class ProductAdmin(nested_admin.NestedModelAdmin):
    ...
    # Exclude the optional fields from being displayed in the admin form
    exclude = [ 'product_stock', 'product_views_count', 'product_brand',  'product_is_available', 'product_owner']
...
class SitesShowFooterAdmin(admin.ModelAdmin):
